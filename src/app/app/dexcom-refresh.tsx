...
export function DexcomRefresh({ connected }: { connected: boolean }) {
  ...
  return <div className="dexcom-refresh" aria-live="polite">
    ...
    {syncing ? <div className="dexcom-refresh-loader"><Rive className="dexcom-rive" src="/rive/liquid-loading-screen.riv" shouldDisableRiveListeners aria-label="Dexcom is refreshing" /><span>Dexcom refresh in progress</span></div> : null}
