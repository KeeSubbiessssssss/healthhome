...
export function DexcomRefresh({ connected }: { connected: boolean }) {
  ...
  return <div className="dexcom-refresh" aria-live="polite">
    ...
    {syncing ? <div className="dexcom-refresh-loader"><Rive src="/rive/liquid-loading-screen.riv" shouldDisableRiveListeners aria-label="Dexcom is refreshing" /><span>Refreshing</span></div> : null}
