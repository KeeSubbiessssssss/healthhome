  ...
  return <main className="app-shell">
    ...
    <section className="content">
      ...
      <section className="metric-grid" aria-label="Health summary">
        <article className="metric-card glucose-card"><div className="card-heading"><div><span className="card-icon coral"><Icon name="pulse" size={19} /></span><p>Glucose</p></div><button aria-label="More glucose options"><Icon name="more" size={19} /></button></div><div className="glucose-reading"><strong>108</strong><span>mg/dL</span><b>→</b></div><p className="status-copy"><span className="status-dot" />In range</p><div className="updated"><span>Last reading at 6:42 pm</span><span>{synced}</span></div></article>
